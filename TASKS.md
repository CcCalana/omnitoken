...
| 7 | T-046 一键 onboard CLI 收口 | `omnitoken adopt <agent>` 交互式 prompts + status + dry-run + 输出 polish | 1d | T-044 + T-045 | todo |

**Phase 3-A 当前焦点**: T-046 CLI 收口——6/7 done，最后一块拼图。完成后 Phase 3-A 收官。
...
## T-046 一键 onboard CLI 收口 [phase:3-A] [owner:codex] [status:review] [started:2026-05-30 13:41 CST]
...
Result: `PENDING` — prompts/status/dry-run/restore-confirm/error polish landed; all green, no deviation.
